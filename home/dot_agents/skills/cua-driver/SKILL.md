...
the persistent `computer` MCP server for GUI workflows. LOCAL.md defines our
Helium profile rules and overrides upstream transport defaults. Installed tool
schemas take precedence over stale examples.
